...
A simple Qt-based desktop app that fetches and displays current GitHub service status with the GitHub Status API.

Displays GitHub services such as:
  - Git Operations
  - Webhooks
  - API Requests
  - Issues
...
Refreshes itself with the click of a button
...
This is to solve the following Task:
